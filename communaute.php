...
<section class="page-hero">
    <div class="container">
        <div class="section-eyebrow">la team nomade</div>
        <h1 class="font-hand">Rejoins la <span class="accent">communauté</span>.</h1>
...
<section class="section" style="padding-top: 30px;">
    <div class="container">
        ...
        <div class="cta-card reveal" style="margin-top: 60px;">
            <span class="tape" style="top:-12px; left:50%; transform:translateX(-50%) rotate(-2deg);"></span>
            <div class="eyebrow">ton propre groupe ?</div>
            <h2>Crée-le avec <span class="circle-hand">nous</span>.</h2>
            <p>Une passion, un quartier, un hobby ? On peut référencer ton groupe dans la communauté Nomade. Contacte-nous sur Instagram.</p>
            <div style="margin-top: 24px;">
                <a href="https://www.instagram.com/nomademediacom" target="_blank" rel="noopener" class="btn btn-coral">
